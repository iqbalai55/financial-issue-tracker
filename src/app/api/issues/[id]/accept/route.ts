// app/api/issues/[id]/accept/route.ts  ← INI LOKASI BENAR!
...
export async function POST(
  ...
  if (issue.status !== 'pending') {
    return NextResponse.json({ error: 'Issue must be pending' }, { status: 400 })
  }
  ...
  return NextResponse.json({ 
    message: '✅ Issue berhasil diterima! Status: accepted' 
  })
}
